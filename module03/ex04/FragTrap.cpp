...
/*   Updated: 2020/12/03 17:38:34 by iboeters      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void			FragTrap::vaulthunter_dot_exe(std::string const & target)
{
	...
	else
	{
		...
		void (FragTrap::* const attacks[3])(std::string const & target) =
		{
			&FragTrap::speedAttack,
			&FragTrap::deadAttack,
			&FragTrap::cyberAttack
		};
		void (ClapTrap::* const attacks2[2])(std::string const & target) =
		{
		...
		{
			(this->*attacks2[(int)index - 3])(target);
		}
	}
}
