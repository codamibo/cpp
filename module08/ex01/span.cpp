...
/*   Updated: 2021/01/07 15:00:17 by iboeters      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int					Span::longestSpan(void)
{
	if (_added <= 1)
		throw NotEnoughNumbersException();
	int min_index = distance(_array.begin(), std::min_element(_array.begin(), _array.end()));
	int max_index = distance(_array.begin(), std::max_element(_array.begin(), _array.end()));
